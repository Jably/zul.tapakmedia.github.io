        ...
        <div class="menu">
            <div class="item">
                ...
                <div class="sub-menu" style="display:block">
                    ...
                    <div class="sub-menu2" style="display:block">
                      ...
                      <a class="selector" href="../pages/cnc-adv-dsktp.php" class="sub-item">Desktop</a>
                    </div>
            ...
            <div class="sub-menu">
                    ...
                    <div class="sub-menu2">
                      ...
                      <a href="../pages/tpks-adv-dsktp.php">Desktop</a>
                    </div>
                    <a class="sub-btn"><i class="fas fa-angle-right dropdown"></i>Pop-Up</a>
                    <div class="sub-menu2">
