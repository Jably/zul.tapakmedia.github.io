        ...
        <div class="menu">
            ...
            <div class="item">
              ...
              <div class="sub-menu" style="display:block">
                ...
                <a class="sub-btn"><i class="fas fa-angle-right dropdown rotate"></i>Banner Home</a>
                <div class="sub-menu2" style="display:block">
                  <a class="sub-btn selector" href="../pages/tpkm-bnr-hm-mbl.php"></i>Mobile</a>
