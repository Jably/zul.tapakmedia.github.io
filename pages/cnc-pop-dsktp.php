            ...
            <div class="item">
                ...
                <div class="sub-menu" style="display:block">
                    ...
                    <div class="sub-menu2"style="display:block">
                      <a class="sub-item" href="../pages/cnc-pop-mbl.php"></i>Mobile</a>
                      <a href="../pages/cnc-pop-dsktp.php" class="sub-item selector">Desktop</a>
                    </div>
