        ...
        <div class="menu">
            <div class="item">
                ...
                <div class="sub-menu">
                    ...
                    <div class="sub-menu2">
                      <a class="sub-btn" href="../pages/cnc-bnr-rbrk-mbl.php"></i>Mobile</a>
                      <a href="../pages/cnc-bnr-rbrk-dsktp.php" class="sub-item">Desktop</a>
                    </div>
                    <a class="sub-btn"><i class="fas fa-angle-right dropdown"></i>Sidebar</a>
                    <div class="sub-menu2">
                      <a class="sub-btn" href="../pages/cnc-sdb-mbl.php"></i>Mobile</a>
                      <a href="../pages/cnc-sdb-dsktp.php" class="sub-item">Desktop</a>
                    </div>
                </div>
          </div>
            <div class="item">
              <a class="sub-btn"><img src="../assets/img/tapak-studio.png" class="img img-fluid3"><i class="fas fa-angle-right dropdown"></i></a>
            <div class="sub-menu">
                    <a class="sub-btn"><i class="fas fa-angle-right dropdown"></i>Advertorial</a>
                    <div class="sub-menu2">
                    ...
                    <div class="sub-menu2">
                      ...
                      <a href="../pages/tpks-sdb-dsktp.php" class="sub-item">Desktop</a>
                    </div>
            </div>
            <div class="item">
              <a class="sub-btn"><img src="../assets/img/logo-sdb.png" class="img img-fluid2"><i class="fas fa-angle-right dropdown rotate"></i></a>
              <div class="sub-menu" style="display:block">
                ...
                <a class="sub-btn"><i class="fas fa-angle-right dropdown rotate"></i>Banner Artikel</a>
                <div class="sub-menu2" style="display:block">
                  <a class="sub-btn selector" href="../pages/tpkm-bnr-art-mbl.php"></i>Mobile</a>
