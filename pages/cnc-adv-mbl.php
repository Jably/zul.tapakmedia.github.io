        ...
        <div class="menu">
            ...
            <a class="sub-btn"><img src="../assets/img/cnc.png" class="img img-fluid4"><i class="fas fa-angle-right dropdown rotate"></i></a>
                <div class="sub-menu" style="display:block">
                    <a class="sub-btn"><i class="fas fa-angle-right dropdown rotate"></i>Advertorial</a>
                    <div class="sub-menu2" style="display:block">
                      <a class="sub-btn selector" href="../pages/cnc-adv-mbl.php"></i>Mobile</a>
                    ...
                    <div class="sub-menu2">
                      ...
                      <a href="../pages/cnc-bnr-rbrk-rbrkdsktp.php" class="sub-item">Desktop</a>
                    </div>
