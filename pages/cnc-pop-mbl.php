        ...
        <div class="menu">
            <div class="item">
                ...
                <div class="sub-menu" style="display:block">
                    ...
                    <a class="sub-btn"><i class="fas fa-angle-right dropdown rotate"></i>Pop-Up</a>
                    <div class="sub-menu2" style="display:block">
                      <a class="sub-btn selector" href="../pages/cnc-pop-mbl.php"></i>Mobile</a>
                    ...
                    <div class="sub-menu2">
                      ...
                      <a href="../pages/cnc-bnr-rbrk-dsktp.php" class="sub-item selector">Desktop</a>
                    </div>
